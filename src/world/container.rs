use super::chunk::{ BlockState, ChunkGrid };

const SECTION_BITS: usize = 16;
const SECTION_CAPACITY: usize = 4096;

/*
**  BitArray - compacted array of blockstates stored as longs (u64)
*/
...
/*
**  ChunkSection - paletted container of blockstate mappings
*/
...
/*
**  ChunkColumn - contains sections at a 2D point
*/
